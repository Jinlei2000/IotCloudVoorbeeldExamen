...
{
    public static class GetMealsByClass
    {
        [FunctionName("GetMealsByClass")]
        public static async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "childern/class/{ClassTag}")] HttpRequest req,
            string ClassTag,
            ILogger log)
        {
            try
            {
                ...
                string sql = $"SELECT c.Meals FROM c WHERE c.ClassTag = '{ClassTag}'";
